...
@section('title', '新增一级指标')

@section('content')
<form method="post" action="{{ route('index.save') }}">
	{{ csrf_field() }}
	...
	<div class="form-group row">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" id="name" name="name" placeholder="一级指标名称" value="{{ old('name') }}" required>
		</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<textarea class="form-control col-md-7 col-xs-12" rows="5" id="description" name="description" placeholder="观测点">{{ old('description') }}</textarea>
		</div>
	</div>
	<div class="form-group row">
