...
<form method="post" action="{{ route('department.update', $department->id) }}" enctype="multipart/form-data">
	...
	<div class="form-group row">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" id="name" name="name" placeholder="部门名称" value="{{ $department->name }}" required>
		</div>
	</div>
	<div class="form-group row">
		<label for="path" class="col-md-3 col-sm-3 col-xs-12 col-form-label text-right">自评材料</label>
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input type="file" class="form-control-file col-md-7 col-xs-12" id="file" name="file" placeholder="自评材料">
		</div>
		<div class="form-text">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="form-check form-check-inline">
					<input type="radio" class="form-check-input" id="yes" name="is_college" value="1"{{ $department->is_college ? ' checked' : '' }}>
					<label for="yes" class="form-check-label">是</label>
				</div>
				<div class="form-check form-check-inline">
					<input type="radio" class="form-check-input" id="no" name="is_college" value="0"{{ $department->is_college ? '' : ' checked' }}>
